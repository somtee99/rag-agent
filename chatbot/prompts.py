...
context_prompt = ChatPromptTemplate.from_messages([
    ("system", (
        ...
        " Use ```python\n...\n``` for code, and <img src='/gradio_api/file=imgs/...'/> for images, always including '/gradio_api/file=' before the link."
    ...
    ("ai", 
        " Use ```python\n...\n``` for code, and <img src='/gradio_api/file=imgs/...'/> for images, always including '/file=' before the link and imgs/slides as directory."
        " Use the previously-provided information as the sole source of context — assume no additional data is available."
